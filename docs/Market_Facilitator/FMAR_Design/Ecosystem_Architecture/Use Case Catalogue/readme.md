...
| UC-01.03 | Customer Onboarding / Offboarding | Update + De-register Organisation           | Manage the lifecycle of an FSP's core entity data and status within the FMAR ecosystem.                                        |    |
