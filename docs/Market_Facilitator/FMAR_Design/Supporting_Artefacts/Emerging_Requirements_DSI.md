...
Elexon fully supports this intent, recognising that parallel initiatives to FMAR in the European Union (e.g., ACER’s Flexibility Information System recommendation) are defined with respect to data spaces as the cornerstone to interoperable data sharing.   
...
| DPN-DC-02: Tagging & Categorisation (MVP) | FSPs/SOs use this to apply FMAR-specific tags (e.g., assetTechnology:BESS, fmarModule:ARM, marketService:DynamicContainment) to their local datasets, aiding discovery and processing by FMAR Hub. |
...
| DPN-IN-03.03 (API Endpoint Management - Pilot) | Local management of these DPN-exposed APIs.|
...
| **DSM-IN: DSM Integration (Live - but FMAR needs influence NOW)** | **CRITICAL. FMAR Hub will be a primary user of these.**|
...
## Open Issues
- What is the timeline for the FMAR Common Ontology to be formally hosted and governed within DSM-SA-01? What support can NESO, NDTP or BSI provide as part of the standards development work required?
